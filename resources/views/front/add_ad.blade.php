...
<div class="form-group mb-4">
    ...
    <textarea class="form-control agagro-form-style-textarea" rows="3" required></textarea>
</div>
...
<div class="form-check mb-3 oferta-block">
  ...
  <label class="form-check-label" for="oferta">
    ...
    <div class="form-group mb-3">
        <input type="submit" class="btn btn-primary add-button" id="submit_organization" value="Разместить">
    </div>
...
<div class="form-check mb-3 oferta-block">
  ...
  <label class="form-check-label" for="oferta">
    ...
    <div class="form-group mb-3">
        <input type="submit" class="btn btn-primary add-button" id="submit_specialist" value="Разместить">
    </div>

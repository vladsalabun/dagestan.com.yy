...
<!-- Главная: -->
    <b><a class="navbar-brand abs pr-4" href="{{URL::to('/')}}">Agargo</a></b>
<!-- /Главная -->
...
@endforelse
            ...
            <li class="nav-item">
                ...
                <span class="border border-primary pt-2 pb-2 pl-4 pr-4 add-button text-primary">
                    Разместить
                </span>
                </a>
            </li>
...
<h1 class="pt-5 pb-3 mini-header">Сервис поиска организаций и услуг</h1>
</div>
...
<!-- Поиск: ---> 
<div class="container-fluid mt-3 pt-2 bg-light">
    <div class="row">
...
<div class="container mini-search">
    <div class="row">
        <div class="col-4 col-md-7 col-lg-7 col-xl-7 p-2">
            <input type="text" name="search" class="top-search-form" placeholder="Поиск по организациям, услугам" id="search_text" value="{{$search_text}}">
        </div>
        <div class="col-5 col-md-3 col-lg-3 col-xl-3 p-2 top-search-category text-center d-none d-sm-block">
            
            <span class="text-muted top-search-category-link border-left pl-3 pr-3 pt-2 pb-2" data-toggle="collapse" href="#CategoryCollapse" role="button" aria-expanded="false" aria-controls="CategoryCollapse">
            Все категории 
        ...
        <div class="col-5 col-md-3 col-lg-3 col-xl-3 p-2 top-search-category text-center d-block d-sm-none">
